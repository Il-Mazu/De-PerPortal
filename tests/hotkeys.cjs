...
(async()=>{
 ...
 const watcher=spawn('wine',['out/SkyPortal-Probe.exe','watch'],{env});
 ...
 try {
  ...
  assert.deepEqual(events,[{type:'hotkey',player:0,key:'1'},{type:'hotkey',player:1,key:'0'},{type:'hotkey',player:0,key:'T'},{type:'hotkey',player:1,key:'T'}]);
  console.log('PASS: Alt+1, Alt+Shift+0, Alt+T, Alt+Shift+T; no event outside Cemu. No game launched.');
