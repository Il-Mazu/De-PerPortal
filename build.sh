...
if command -v x86_64-w64-mingw32-gcc >/dev/null; then
    x86_64-w64-mingw32-gcc -std=c11 -Wall -Wextra -Werror -O2 prototype/portal.c -o out/SkyPortal-Probe.exe -luser32 -lshlwapi -ladvapi32 -lshell32
    ...
    clang --target=x86_64-w64-windows-gnu --sysroot="$sysroot" -fuse-ld=lld -nostdlib \
        ...
        "$sysroot/lib/crtend.o" -o out/SkyPortal-Probe.exe
else
